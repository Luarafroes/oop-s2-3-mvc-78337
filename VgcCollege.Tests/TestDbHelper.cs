...
namespace VgcCollege.Tests.Helpers
{
    public static class TestDbHelper
    {
        ...
        private static void SeedTestData(AppDbContext context)
        {
            ...
            // Seed Courses
            var course1 = new Course { Id = 1, Name = "Software Development", BranchId = 1, StartDate = DateTime.Today.AddMonths(-2), EndDate = DateTime.Today.AddMonths(4) };
            ...
            var course3 = new Course { Id = 3, Name = "Cybersecurity", BranchId = 2, StartDate = DateTime.Today.AddMonths(-1), EndDate = DateTime.Today.AddMonths(5) };
            ...
            var student1 = new StudentProfile { Id = 1, Name = "Luara Froes", Email = "luara@vgc.com", StudentNumber = "VGC001", Phone = "0861234567" };
            var student2 = new StudentProfile { Id = 2, Name = "Bob Walsh", Email = "bob@vgc.com", StudentNumber = "VGC002", Phone = "0867654321" };
            var student3 = new StudentProfile { Id = 3, Name = "Alice Ryan", Email = "alice@vgc.com", StudentNumber = "VGC003", Phone = "0869876543" };
            ...
            // Seed Assignments
            var assignment1 = new Assignment { Id = 1, CourseId = 1, Title = "Console App Project", MaxScore = 100, DueDate = DateTime.Today.AddDays(-10) };
            var assignment2 = new Assignment { Id = 2, CourseId = 1, Title = "OOP Final Project", MaxScore = 100, DueDate = DateTime.Today.AddDays(10) };
            ...
            context.ExamResults.AddRange(
                new ExamResult { Id = 1, ExamId = 1, StudentProfileId = 1, Score = 88, Grade = "B+" },
                new ExamResult { Id = 2, ExamId = 1, StudentProfileId = 2, Score = 75, Grade = "C+" },
                new ExamResult { Id = 3, ExamId = 2, StudentProfileId = 1, Score = 78, Grade = "C+" },  // Student 1's hidden exam result
                new ExamResult { Id = 4, ExamId = 3, StudentProfileId = 3, Score = 82, Grade = "B" }
            );
