...
namespace VgcCollege.Web.Data
{
    public static class SeedData
    {
        public static async Task InitialiseAsync(IServiceProvider serviceProvider)
        {
            ...
            // Seed Users
            var adminUser = await CreateUser(userManager, "admin@vgc.com", "Letmein01*", "Admin");
            var facultyUser1 = await CreateUser(userManager, "wenhao.fu@vgc.com", "Letmein01*", "Faculty");
            var facultyUser2 = await CreateUser(userManager, "rod.haanappel@vgc.com", "Letmein01*", "Faculty");
            var facultyUser3 = await CreateUser(userManager, "john.rowley@vgc.com", "Letmein01*", "Faculty");
            var studentUser1 = await CreateUser(userManager, "luara@vgc.com", "Letmein01*", "Student");
            var studentUser2 = await CreateUser(userManager, "student2@vgc.com", "Letmein01*", "Student");
            var studentUser3 = await CreateUser(userManager, "helder@vgc.com", "Letmein01*", "Student");
            var studentUser4 = await CreateUser(userManager, "wesley.oliveira@vgc.com", "Letmein01*", "Student");
            var studentUser5 = await CreateUser(userManager, "larissa.sousa@vgc.com", "Letmein01*", "Student");
            var studentUser6 = await CreateUser(userManager, "carlos.camargo@vgc.com", "Letmein01*", "Student");
            var studentUser7 = await CreateUser(userManager, "manar.ahkim@vgc.com", "Letmein01*", "Student");
            var studentUser8 = await CreateUser(userManager, "caio.pereira@vgc.com", "Letmein01*", "Student");
            ...
            if (!context.ExamResults.Any())
            {
                context.ExamResults.AddRange(
                    // Exam 1 — Programming (Released) — Luara, Helder, Wesley, Larissa, Manar, Caio enrolled
                    ...
                    // Exam 2 — Database (Released) — Luara, Wesley, Larissa, Carlos, Manar enrolled
                    ...
                    // Exam 3 — OS (Hidden) — Bob, Helder, Carlos, Manar, Caio enrolled
                    ...
                    // Exam 4 — AI (Hidden) — Luara, Bob, Wesley, Larissa, Manar enrolled
                    ...
                    // Exam 5 — Cloud (Hidden) — Luara, Bob, Helder, Larissa, Carlos, Manar, Caio enrolled
                    ...
                    // Exam 6 — Cybersecurity (Hidden) — Bob, Helder, Wesley, Carlos, Caio enrolled
